...
/***/ "../../../../../src/app/layout/dashboard/dashboar-data.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DashboarDataModel; });
var DashboarDataModel = (function () {
    function DashboarDataModel() {
        ...
        this.BarChartData = [];
        this.AccountDataColumnList = ['Accounts', 'Tagged', 'Pending to tag', 'Total'];
        this.GeneraDataColumnList = ['', 'No of Projects', 'Value(In Lacs)'];
        this.EnquiryDataRowList = [];
        this.ConversionDataRowList = [];
        this.OrderLostDataRowList = [];
        this.PipelineDataRowList = [];
        this.PipelineFunnelData = [];
        this.PipelineFunnelLabels = ['Enquiry', 'Pipeline', 'Conversion'];
        this.PipelineFunnelLegend = true;
        this.PolarAreaChartType = 'polarArea';
    }
    return DashboarDataModel;
}());

//# sourceMappingURL=dashboar-data.model.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dashboard_service__ = __webpack_require__("../../../../../src/app/layout/dashboard/dashboard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_toastr_ng2__ = __webpack_require__("../../../../toastr-ng2/toastr.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dashboar_data_model__ = __webpack_require__("../../../../../src/app/layout/dashboard/dashboar-data.model.ts");
...
var DashboardComponent = (function () {
    function DashboardComponent(titleService, _dashboardService, modalService, _currencyPipe, _toastrService) {
        ...
        this.dashboarDataModel = new __WEBPACK_IMPORTED_MODULE_5__dashboar_data_model__["a" /* DashboarDataModel */]();
    ...
    DashboardComponent.prototype.openInformationModel = function (type) {
        if (type == 'Account') {
    ...
    DashboardComponent.prototype.getDismissReason = function (reason) {
        if (reason === __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["f" /* ModalDismissReasons */].ESC) {
            return 'by pressing ESC';
        }
        else if (reason === __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["f" /* ModalDismissReasons */].BACKDROP_CLICK) {
    ...
    DashboardComponent.prototype.getDashboardDetails = function () {
        var _this = this;
        this.loading = true;
        this._dashboardService.getDashboardDetails().subscribe(function (result) {
            _this.loading = false;
            if (result.Error) {
                ...
                var item = [result.PipelineFunnelLabels.Enquiry,
                    result.PipelineFunnelLabels.Pipeline,
                    result.PipelineFunnelLabels.Conversion];
                _this.dashboarDataModel.PipelineFunnelData.push(item);
                _this.dashboarDataModel.DoughnutChartLabels = result.DoughnutChartLabels;
                _this.dashboarDataModel.DoughnutChartData = result.DoughnutChartData;
                _this.dashboarDataModel.BarChartConversionData = result.BarChartConversionData;
                _this.dashboarDataModel.BarChartLabels = result.BarChartLabels;
                _this.dashboarDataModel.BarChartOrderLostData = result.BarChartOrderLostData;
                _this.dashboarDataModel.BarChartData = [
                    { data: _this.dashboarDataModel.BarChartConversionData, label: 'Conversion' },
                    { data: _this.dashboarDataModel.BarChartOrderLostData, label: 'Lost' }
                ];
                _this.dashboarDataModel.AccountsNoCount = 0;
                for (var i = 0; i < result.AccountInformationData.Data.length; i++) {
                    var item_1 = [result.AccountInformationData.Data[i].Accounts,
                    ...
                    _this.dashboarDataModel.AccountsNoCount = _this.dashboarDataModel.AccountsNoCount + parseInt(result.AccountInformationData.Data[i].Total);
                    _this.dashboarDataModel.AccountDataRowList.push(item_1);
                }
                _this.dashboarDataModel.ConversionNoCount = 0;
                _this.dashboarDataModel.ConversionValueCount = 0;
                for (var i = 0; i < result.ConversionInformationData.length; i++) {
                    _this.dashboarDataModel.ConversionNoCount = result.ConversionInformationData[i].TypeNo; //this.dashboarDataModel.ConversionNoCount + parseInt(result.ConversionInformationData[i].TypeNo);
                    _this.dashboarDataModel.ConversionValueCount = _this.dashboarDataModel.ConversionValueCount + parseInt(result.ConversionInformationData[i].TotalValue);
                    var totalValue = _this._currencyPipe.transform(result.ConversionInformationData[i].TotalValue, '1.2-2');
                    var item_2 = [result.ConversionInformationData[i].TypeName,
                        result.ConversionInformationData[i].TypeNo, totalValue];
                    _this.dashboarDataModel.ConversionDataRowList.push(item_2);
                }
                _this.dashboarDataModel.PipelineNoCount = result.PipelineInformationData[4].TypeNo;
                _this.dashboarDataModel.PipelineValueCount = 0;
                for (var i = 0; i < result.PipelineInformationData.length; i++) {
                    ...
                    _this.dashboarDataModel.PipelineValueCount = _this.dashboarDataModel.PipelineValueCount + parseInt(result.PipelineInformationData[i].TotalValue);
                    var totalValue = _this._currencyPipe.transform(result.PipelineInformationData[i].TotalValue, '1.2-2');
                    var item_3 = [result.PipelineInformationData[i].TypeName,
                        result.PipelineInformationData[i].TypeNo, totalValue];
                    _this.dashboarDataModel.PipelineDataRowList.push(item_3);
                }
                _this.dashboarDataModel.OrderLostNoCount = 0;
                _this.dashboarDataModel.OrderLostValueCount = 0;
                for (var i = 0; i < result.LostInformationData.length; i++) {
                    _this.dashboarDataModel.OrderLostNoCount = result.LostInformationData[i].TypeNo; //this.dashboarDataModel.OrderLostNoCount + parseInt(result.LostInformationData[i].TypeNo);
                    _this.dashboarDataModel.OrderLostValueCount = _this.dashboarDataModel.OrderLostNoCount + parseInt(result.LostInformationData[i].TotalValue);
                    var totalValue = _this._currencyPipe.transform(result.LostInformationData[i].TotalValue, '1.2-2');
                    var item_4 = [result.LostInformationData[i].TypeName,
                        result.LostInformationData[i].TypeNo, totalValue];
                    _this.dashboarDataModel.OrderLostDataRowList.push(item_4);
                }
                _this.dashboarDataModel.EnquiryNoCount = 0;
                _this.dashboarDataModel.EnquiryValueCount = 0;
                for (var i = 0; i < result.EnquiryInformationData.length; i++) {
                    _this.dashboarDataModel.EnquiryNoCount = result.EnquiryInformationData[i].TypeNo; //this.dashboarDataModel.EnquiryNoCount + parseInt(result.EnquiryInformationData[i].TypeNo);
                    _this.dashboarDataModel.EnquiryValueCount = _this.dashboarDataModel.EnquiryValueCount + parseInt(result.EnquiryInformationData[i].TotalValue);
                    var totalValue = _this._currencyPipe.transform(result.EnquiryInformationData[i].TotalValue, '1.2-2');
                    var item_5 = [result.EnquiryInformationData[i].TypeName,
                        result.EnquiryInformationData[i].TypeNo, totalValue];
                    _this.dashboarDataModel.EnquiryDataRowList.push(item_5);
                }
            }
        });
    };
    DashboardComponent.prototype.checkArrayContainAllZero = function (arrayElement) {
        return arrayElement ? arrayElement.every(function (element) { return element == 0 || element == '0'; }) : true;
    };
...
DashboardComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_3__dashboard_service__["a" /* DashboardService */], __WEBPACK_IMPORTED_MODULE_4_toastr_ng2__["b" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_7__angular_common__["DecimalPipe"]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__["b" /* Title */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__["b" /* Title */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__dashboard_service__["a" /* DashboardService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__dashboard_service__["a" /* DashboardService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["g" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["g" /* NgbModal */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_7__angular_common__["DecimalPipe"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__angular_common__["DecimalPipe"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4_toastr_ng2__["b" /* ToastrService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_toastr_ng2__["b" /* ToastrService */]) === "function" && _e || Object])
], DashboardComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dashboard_routing_module__ = __webpack_require__("../../../../../src/app/layout/dashboard/dashboard-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dashboard_component__ = __webpack_require__("../../../../../src/app/layout/dashboard/dashboard.component.ts");
...
Chart.layouts = __webpack_require__("../../../../chart.js/src/core/core.layouts.js");
Chart.platform = __webpack_require__("../../../../chart.js/src/platforms/platform.js");
Chart.plugins = __webpack_require__("../../../../chart.js/src/core/core.plugins.js");
Chart.Ticks = __webpack_require__("../../../../chart.js/src/core/core.ticks.js");
...
var plugins = __webpack_require__("../../../../chart.js/src/plugins/index.js");
...
var layouts = __webpack_require__("../../../../chart.js/src/core/core.layouts.js");
var platform = __webpack_require__("../../../../chart.js/src/platforms/platform.js");
var plugins = __webpack_require__("../../../../chart.js/src/core/core.plugins.js");
...
module.exports = {};
module.exports.filler = __webpack_require__("../../../../chart.js/src/plugins/plugin.filler.js");
module.exports.legend = __webpack_require__("../../../../chart.js/src/plugins/plugin.legend.js");
module.exports.title = __webpack_require__("../../../../chart.js/src/plugins/plugin.title.js");
