...
module.exports = "<app-header [isSidebarInActive]=\"isSidebarInActive\"\n        (sidebarEvent)=\"getSidebarEvent($event)\"></app-header>\n<ng-container *ngIf=\"!isSidebarInActive\">\n        <app-sidebar></app-sidebar>\n</ng-container>\n<section class=\"main-container\" [ngClass]=\"{'hide-sidebar':isSidebarInActive}\" style=\"background-color:#EDEEF2;\">        \n    <router-outlet></router-outlet>\n</section>\n"
...
var LayoutComponent = (function () {
    ...
    LayoutComponent.prototype.getSidebarEvent = function (event) {
        if (event == "false") {
            this.isSidebarInActive = false;
        }
        else {
